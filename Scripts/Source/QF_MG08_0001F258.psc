...
if MGRArniel02.GetStage() == 200
	MGRArniel03.Start()
endIf
AldmeriDominionFaction.SetAlly(PlayerFaction)
ThalmorFaction.SetAlly(PlayerFaction)
EmbassyDoor.setopen(true)
EmbassyFrontGate.SetOpen(true)
BlockDoor.Blockactivation(false)
_SWT_AnemirQuest.Start()
_SWT_AnemirQuest.Setstage(0)
self.Stop()
;END CODE
EndFunction
;END FRAGMENT
...
if ! (DialogueWinterholdCollege as dialoguewinterholdcollegequestscript).EstormoOfferAccepted
    ...
    (DialogueWinterholdCollege as dialoguewinterholdcollegequestscript).ShowAnemirJoinThalmorQuestDialogue = True
else
    self.SetObjectiveDisplayed(35, 1 as Bool, false)
     (DialogueWinterholdCollege as dialoguewinterholdcollegequestscript).ShowAnemirJoinThalmorQuestDialogue = False
endIf
...
ObjectReference Property BlockDoor  Auto  

Quest Property _SWT_AnemirQuest  Auto  

Faction Property AldmeriDominionFaction  Auto  
