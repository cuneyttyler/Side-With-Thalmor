...
if _SWT_MG08_EstormoOfferAccepted.GetValueInt() == 0
   ...
   _SWT_ShowAnemirJoinThalmorQuestDialogue.SetValueInt(1)
else
    self.SetObjectiveDisplayed(35, 1 as Bool, false)
     _SWT_ShowAnemirJoinThalmorQuestDialogue.SetValueInt(0)
endIf
...
GlobalVariable Property _SWT_ShowAnemirJoinThalmorQuestDialogue  Auto  
